      ...
      <div className={cls.info}>
        <div className={cls.contacts}>
          <ul className={cls.address}>
            <li className={cls.address_title}>{t("Адрес")}</li>
            <li className={cls.address_item}>{t("Российская Федерация")}</li>
            <li className={cls.address_item}>
              <a className={cls.address_link} href="https://t.me/polenov_dv">
                <Phone />
                polenov_dv
              </a>
            </li>
          ...
          <div className={cls.social}>
            ...
            <ul className={cls.social_list}>
              ...
              <li className={cls.social_item}>
                <a
                  className={`${cls.social_link} ${cls.github}`}
                  href="https://github.com/polenov-dv"
                >
                  <Github />
                </a>
              </li>
        ...
        <div className={cls.form_wrapper}>
          <p className={cls.title_form}>{t("Напишите мне")}</p>
